...
export default function EnquiryFormModal({
    ...
    const validate = () => {
        ...
        if (!isProspectus && !form.message.trim()) e.message = "Message is required";
        return e;
    };
    ...
    const inputClass = (field) =>
        `w-full px-4 py-3 border rounded-sm font-secondary text-sm text-gray-700 placeholder-gray-400 outline-none transition-colors duration-200 focus:border-brand-secondary ${errors[field]
                                ...
                                <>
                                    ...
                                    <div className="mb-6">
                                        <h3 className="text-2xl font-bold text-brand-accent font-primary leading-tight">
                                            {isProspectus ? (
                                                <>Download <span className="text-brand-primary">Prospectus</span></>
                                            ) : (
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        ...
                                        <motion.button
                                            ...
                                            className={`w-full py-3 rounded-sm font-secondary text-sm font-semibold tracking-wide text-white transition-all duration-300 cursor-pointer ${submitting
