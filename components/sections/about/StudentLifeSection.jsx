    ...
    <section className="py-20 lg:py-28 bg-[#f5f5f5] overflow-hidden relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            Experience a community where learning extends beyond the classroom. From spirited athletic competitions to inspiring artistic performances, every day is an opportunity to grow.
          </motion.p>
        </div>
